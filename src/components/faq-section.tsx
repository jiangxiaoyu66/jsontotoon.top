...
/** 纯 CSS 展开/收起的 FAQ，使用原生 details/summary，内容始终在 DOM 内，利于 SEO */
export const FAQSection = async () => {
  const t = await getTranslations('faq');

  return (
    <section id="faq" className="py-32 px-4 relative bg-[#0a0a0f]" aria-labelledby="faq-heading">
      <div className="max-w-3xl mx-auto">
        <h2 id="faq-heading" className="text-5xl font-black text-center mb-20 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
          {t('title')}
        </h2>
